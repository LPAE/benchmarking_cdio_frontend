...
export default class EditExpectativa extends React.Component {
  ...
  async componentDidMount() {
    ...
    if (Object.keys(turma.data.expectativa).includes('design')) 
      this.setState({ ...this.state, design: turma.data.expectativa.design });
    ...
    if (Object.keys(turma.data.metrica).includes('design')) 
      this.setState({ ...this.state, designMetrica: turma.data.metrica.design });
